...
## Package strategator
Ce package fait partie du [game_interacor](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_interactor), il contient les classes chargée des stratégie des character. La classe [Stratégie](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Strategy.java) a pour objectif de fournir aux [Behaviours](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) différentes stratégies, que ce soit afin de choisir un carte [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) ou bien une cible pour exécuter un sort. La classe [Predict](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Predict.java) va analyser les villes de tous les joueurs pour chercher quel joueur possède potentiellement quel [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java).
...
Le [Controller](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_engine/Controller.java) va par la suite demander au [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) de lancer la partie, et une fois qu’un des joueurs a complété sa ville (cf. [City](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/City.java)), le [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) renvoie une liste de [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) qui ont terminé leurs ville, classé du premier au dernier à l'avoir complété.
...
Le [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) est chargé de gérer la partie le déroulement des tours (cf. `runRounds()`). Il utilise l'ArrayList "listOfBehaviour", afin de demander à chaque [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) de piocher une carte [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java).

Cette opération va permettre d'instancier une LinkedHashMap comportant un [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) et un optional de [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) hashOfCharacters qui va associer les [Behaviours](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) et leurs [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) pour le tour actuel (cf. `setupCharacters()`). Nous avons choisi d'utiliser une LinkedHashMap car elle nous permettait de conserver l'ordre d'appel des [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) tout en associant [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) et [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java).

Si au tour précédent le [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) Rois a été associé à un [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java), alors il choisira son rôle en premier (cf. `updateListOfBehaviour()`)

Une fois que chaque [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) est associé à un [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java), le [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) va demander à chaque rôle les uns après les autres de jouer leurs tours (cf. `askEachCharacterToPlay()`)

Une fois que chaque [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) à joué, le [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) regarde si un des joueurs a complété sa ville. Si personne n'a terminé sa ville, un nouveau tour commence. Dans le cas où quelqu'un a terminé sa ville, le [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) arrête la partie et renvoie une liste de [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) qui ont terminé leurs ville, classé du premier au dernier à l'avoir complété. 

## [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java)
Comme dit précédemment nous avons séparé la partie réflexion de la partie action car la partie action est idendique qu’un bot joue de manière passive ou agressive. Le cerveau du bot est donc la classe [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java), qui possède autant de sous-classes que de bot que nous avons implémenté de bots, actuellement trois :
* **[Investor](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/NormalBot.java) :** Va chercher à construire n’importe quel [District](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/District.java), en priorisant les plus cher.
* **[Rusher](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/RushBot.java) :** Va chercher à poser les [District](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/District.java) les moins cher pour compléter sa [ville](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/City.java).
* **[Strategator]() :** Essaye de prédire quel robot possède quel [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) afin de faire des choix.

Un [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) à pour seul but de réfléchir à quelle action il va réaliser, ou autrement dit qu’est ce qu’il va faire durant un tour de jeu. Lors d’un tour un [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) va dans un premier temps si c’est possible utiliser le spell de son [Character](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game/Character.java) . Par la suite il aura à faire un choix, soit il prend 2 golds soit il pioche 2 cartes mais n’en garde qu’une seule. Ce choix dépend exclusivement de la stratégie du [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java). 

### Pour l’[Investor](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/NormalBot.java)
...
### Propre à chaque sous-classes de [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java) : le choix entre deux carte
* L’[Investor](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/NormalBot.java) va choisir la carte la plus cher.
* Le [Rusher](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/RushBot.java) va choisir la carte la moins cher.
...
Notre classe [PrinterCitadels](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/output/PrintCitadels.java) est une classe ou toutes ses méthodes sont accessibles de manière static. Afin de régler ce problème nous avons imaginé une nouvelle classe dans le package [game_interactor](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/tree/master/src/main/java/fr/unice/polytech/citadelle/game_interactor) qui aurait pour tâche de "récolter” toutes les actions réalisées par le bot, les characters et les districts spéciaux. Cette classe renverrait une ArrayList que l’on remonterait au [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) à la fin du tours du [Behaviour](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_interactor/Behaviour.java), puis le [Round Manager](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/game_engine/RoundManager.java) demanderait à [PrintCitadels](https://github.com/pns-si3-projects/projet2-ps5-21-22-ps5-21-22-projet2-k/blob/master/src/main/java/fr/unice/polytech/citadelle/output/PrintCitadels.java) d’afficher le contenu de l’ArrayList.
